...
The complete initial art pass contains one asset for every stage from `stage-00.png` through `stage-12.png`. The manifest is the stable lookup contract used by the dashboard.
