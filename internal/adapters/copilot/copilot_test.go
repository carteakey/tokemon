...
func TestParseShutdownUsageWithoutCollectingSessionContent(t *testing.T) {
	...
	fixture := strings.Join([]string{
		`{"type":"session.start","timestamp":"2026-07-13T12:00:00Z","data":{"sessionId":"session-private-title","startTime":"2026-07-13T12:00:00Z","context":{"cwd":"/private/repos/Carteakey.dev"}}}`,
	...
	if event.SessionID != "session-private-title" || event.Project != "carteakey.dev" {
