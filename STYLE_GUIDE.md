...
- Harness rows use stable preset glyphs for known tools such as Codex, Claude Code, GitHub Copilot CLI, OpenCode, and Antigravity. Model rows use a mirrored 5×5 glyph derived from the normalized model name.
