...
product story, privacy promise, evolution archive, installation path, Tokedex
summary, current adapter coverage, and links to the source repository and
current release.
...
- [Latest Tokemon release](https://github.com/carteakey/tokemon/releases/tag/v0.3.3)
